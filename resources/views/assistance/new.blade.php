                    ...
                    <form method="post" action="{{route('assistance.store')}}">
                        ...
                        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                            <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
                                ...
                                <select name="" class="block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                            ...
                            <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
                                ...
                                <select name="" class="block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                                    <option class="text-black">Aberta</option>
                                    <option class="text-black">Finalizada</option>
                                </select>
                            </div>
                            <div class="w-full sm:w-1/4 px-4 mb-4 sm:mb-0">
                                <span class="text-sm font-medium dark:text-gray-300 text-gray-900">Garantia:</span>
                                <select id="garantia" class="block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                        ...
                        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                            <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
                                ...
                                <input id="qnt_hora" type="text" name="" class="block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                            </div>
                            <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
                            ...
                            <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
                                ...
                                <select name="" class=" block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                                    <option class="text-black">abc</option>
                                    <option class="text-black">dfg</option>
                                </select>
                            </div>
                        </div>
                        <!-- DIV 2 INPUT -->
                        ...
                        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                            <div class="w-full sm:w-1/2 px-4 mb-4 sm:mb-0">
                                ...
                                <input id="preco_hora" type="date" name="" class="block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                            </div>
                            <div class="w-full sm:w-1/2 px-4 mb-4 sm:mb-0">
                        ...
                        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                            <div class="w-full px-4 mb-4 sm:mb-0">
                                ...
                                <select id="projeto" class="block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                        ...
                        <div class="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                            ...
                            <div class="w-full sm:w-2/3 px-4">
                                <div id='desc_ass' class="max-w-xl"><textarea name="observacao" class="block h-56 py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg resize-none"   type="text" placeholder="Digite aqui.."></textarea></div>
                            </div>
                        </div>
