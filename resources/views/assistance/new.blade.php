                    ...
                    <form method="post" action="{{route('assistance.store')}}">
                        ...
                        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
                            ...
                            <div class="w-full sm:w-1/2 px-4 mb-4 sm:mb-0">
                                ...
                                <input id="percentage" type="number" name="percentage" value="0" class="block py-4 px-3 w-full text-sm dark:text-gray-300 text-black placeholder-gray-600 font-medium outline-none bg-transparent border border-gray-400 hover:border-black dark:hover:border-white focus:border-green-500 rounded-lg">
                            </div>
                        </div>
                        <!-- DIV 4 INPUT -->
                        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
