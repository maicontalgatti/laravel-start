            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 dark:bg-gray-700 bg-gray-100 rounded-lg">
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <div class="w-full sm:w-1/6 mb-2 sm:mb-0">Municipio</div>
                        <div class="w-full sm:w-1/6 mb-2 sm:mb-0">UF</div>
                        <div class="w-full sm:w-1/6 mb-2 sm:mb-0">Contato</div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm my-2 sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex flex-col sm:flex-row">
                            <div class="w-full sm:w-2/6 mb-2 sm:mb-0 text-blue-500 font-semibold">{{$pessoa->nome_completo}}</div>
                            <div class="w-full sm:w-1/6 mb-2 sm:mb-0">{{$pessoa->municipio}}</div>
                            <div class="w-full sm:w-1/6 mb-2 sm:mb-0"></div>
                            <div class="w-full sm:w-1/6 mb-2 sm:mb-0">{{$pessoa->uf}}</div>
                            <div class="w-full sm:w-1/6 mb-2 sm:mb-0">{{$pessoa->fone}}</div>
                            <div class="w-full sm:w-1/6 mb-2 sm:mb-0"> </div>
                        </div>
                    </div>
                </div>
