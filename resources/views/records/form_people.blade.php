                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="sm:flex">
                            <div style="width: 100%;" class="sm:w-40">
                                <label for="city1" class="dark:text-gray-100 block text-sm font-medium leading-6 text-gray-900 new_cs">City 1</label>
                                <div class="mt-12">
                            ...
                            <div style="width: 100%;" class="sm:w-40">
                                <label for="city2" class="dark:text-gray-100 block text-sm font-medium leading-6 text-gray-900">City 2</label>
                                <div class="mt-12">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mt-6" style="margin-top: 0px!important">
                            <a href="#" class="flex items-center justify-center rounded-md border border-transparent px-6 py-3 text-base font-medium text-white shadow-sm">
